...
git-commit:
	...
	echo -e "\033[32mCommitting changes in \"CartesianCategories\"\033[0m"; \
	git add .; \
	git commit \
		...
		echo -e "\033[33mNo changes in \"CartesianCategories\" to commit or no version bump detected.\033[0m"; \
	fi
